...
function admin_page() {
    ...
    <strong><?php('title:','rss-this'); ?></strong><?php _e('Shows or hides the feed title. Set to 0 to hide Title (default=1 Title showing)','rss-this'); ?></em><br>
    ...
    <strong><?php _e('more :','rss-this'); ?></strong><?php('Shows or hides a "Read More" button. Set to 0 to hide button. (default=1 Button showing)','rss-this'); ?><br>
